...
break
*/
case 'shoes': case 'shoesss': case 'help': {
...
`,
    ...
    sections
      ...
      var buffer = await getBuffer(ppuser)
      let buttons = [
        {buttonId: `nike`, buttonText: {displayText: 'NIKE'}, type: 1},
        {buttonId: `adidas`, buttonText: {displayText: 'ADIDAS'}, type: 1},
        {buttonId: `nb`, buttonText: {displayText: 'NEW BALANCE'}, type: 1},
        ]
        let buttonMessage = {
        document: fs.readFileSync('./Launcher/lib/tes.xlsx'),
        mimetype: dripsee,
